...
class LocationInformationViewController: UIViewController {
    ...
    private func attribute() {
        ...
        currentLocationButton.setImage(UIImage(systemName: "location.fil"), for: .normal)
...
extension LocationInformationViewController: CLLocationManagerDelegate {
    func locationManager(_ manager: CLLocationManager, didChangeAuthorization status: CLAuthorizationStatus) {
        ...
        case .authorizedAlways,
            ...
            return
        default:
            viewModel.mapViewError.accept(MTMapViewError.loactionAuthorizationDenied.localizedDescription)
            return
        }
    }
}
